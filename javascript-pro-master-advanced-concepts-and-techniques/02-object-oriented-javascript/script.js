...
/* 
{
  ...
  // Dot Notation:
  console.log(person.name); // Mahmud
  person.age = 25;
  ...
  console.log(keys); // ['name', 'profession', 'country']

  // Using Object.values():
  const values = Object.values(person);
  console.log(values); // ['Mahmud', 'Software Engineer', 'Bangladesh']

  // Using Object.entries():
  const entries = Object.entries(person);
  console.log(entries);
  // [['name', 'Mahmud'], ['profession', 'Software Engineer'], ['country', 'Bangladesh']]

  // 5. Checking for Properties

  // Using the in Operator:
  console.log('name' in person); // true
  console.log('age' in person); // false (since age was deleted)
...
/* 
{
  ...
  car.drive(80); // Toyota Corolla is driving at 80 km/h.
  ...
  user.displayInfo(); // Username: mahmud123, Email: mahmud@example.com
  ...
  person1.greet(); // Hello, my name is Mahmud
  ...
  person2.greet(); // Hello, my name is Mahmud
}
 */
...
/* 
{
  ...
  // NOTE: A constructor function is a regular function, but when called with the `new` keyword, it creates an instance of an object. Constructors define the properties and behavior of that object.
  ...
  // 6. Inheritance with Constructors (DON'T use in modern JS)

  // Inheritance allows one constructor to acquire properties and methods from another constructor. In ES5, inheritance is achieved using prototype and call().
  ...
  // ✅ Instead, In ES6, inheritance is simpler with the "extends" keyword:
  class ParentCl {
    constructor(name) {
      this.name = name;
    }
...
/* 
{
  // 2.`Using Constructor Functions`: Before ES6 introduced the class syntax, constructor functions were used to create objects and implement inheritance. (DON'T use in modern JS)
  ...
  // 3.`Using Object.create()`: This method is a simple way to create a new object that inherits from an existing object. It's often used in prototypal inheritance. (DON'T use in modern JS)
  ...
  // ✅ 4.`Using ES6 class Syntax`: In ES6, JavaScript introduced a cleaner and more familiar syntax for implementing inheritance through class. This syntax is just syntactic sugar over the existing prototype-based inheritance system.
  ...
  console.log(dog2.__proto__.__proto__.__proto__ === Object.prototype); // Top of the prototype chain
...
/* 
{
  ...
  console.log(CarCl.manufacturer); // Accessing the static property, "Toyota"
  console.log(CarCl.getManufacturer()); // "Toyota"
  ...
  console.log(CounterCl.getCount()); // 2
