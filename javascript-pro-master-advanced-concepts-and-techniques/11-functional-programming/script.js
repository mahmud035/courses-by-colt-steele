...
/* 
{
...

  {
    ...
    function printMessage(callback, value) {
...

  {
    ...
    // NOTE: Functional programming emphasizes declarative code, which focuses on What To Do (Declarative) rather than How To Do It (imperative style). Higher-order functions like `map()`, `filter()`, and `reduce()` enable a declarative style of coding.
...
/* 
{
...

  {
    ...
    const outerFunction = (outerVar) => (innerVar) =>
      `Outer: ${outerVar}, Inner: ${innerVar}`;
...
/* 
{
...

  {
    ...
    console.log(composedFunction(5)); // 20
  }
}
 */
