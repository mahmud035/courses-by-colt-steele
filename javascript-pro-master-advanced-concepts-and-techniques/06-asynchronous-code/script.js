...
/* 
{
...

  {
    ...
    const myPromise = new Promise((resolve, reject) => {
      ...
      else reject('There was an error during the operation');
    });
...
/* 
{
...

  {
    ...
    const post = await fetchPost(); // Top level await
    console.log(post);
  }
...

  {
    ...
    myPromise
      ...
      .catch((error) => {
        ...
        throw error; // NOTE: Re-throw the error to propagate it further
      })
      .catch((error) => {
...
/* 
{
...

  {
    ...
    console.log(await getUserData()); // Top level await
...
{
  {
    ...
    const myPromise = new Promise((resolve, reject) => {
      ...
      setTimeout(() => {
        ...
        if (success) resolve('The operation was successful');
        else reject('There was an error in the operation');
      }, 2000);
    });

    // Using the promise
    myPromise
      .then((data) => console.log(data)) // Logs: "The operation was successful!" after 2 seconds
      .catch((error) => console.error(error)); // This would run if `reject` was called
  }
