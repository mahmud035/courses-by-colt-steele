...
/* 
{
  ...
  {
    // 3. Immediate Cancellation: You can cancel an interval immediately after setting it, which prevents the interval from ever running. This is useful when certain conditions change soon after the interval is set.
